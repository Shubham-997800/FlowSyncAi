    ...
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-gray-900 flex">
      <div className="hidden lg:flex flex-col justify-between w-[40%] bg-white dark:bg-gray-800 p-12 border-r border-gray-200 dark:border-gray-700">
        <div>
          ...
          <div className="mt-12">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white leading-tight">Start Organizing Smarter.</h1>
            <p className="text-gray-500 dark:text-gray-400 mt-3 text-sm leading-relaxed">
              Create your FlowSync AI account and let AI manage your productivity.
            </p>
          </div>
          <div className="mt-10 space-y-5">
            {[
              ...
              <div key={title} className="flex items-start gap-3 p-3 rounded-xl bg-gray-50 dark:bg-gray-700/50">
                <div className="w-9 h-9 rounded-lg bg-emerald-100 dark:bg-emerald-900/40 flex items-center justify-center flex-shrink-0 mt-0.5">
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-8 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 shadow-sm">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Start your productivity journey.</p>
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type={showConfirm ? 'text' : 'password'} required value={form.confirmPassword} onChange={e => setForm({ ...form, confirmPassword: e.target.value })}
                    ...
                    className="w-full pl-10 pr-10 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-sm transition" />
                  <button type="button" onClick={() => setShowConfirm(!showConfirm)} className="absolute right-3.5 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition">
              ...
              <label className="flex items-start gap-2 cursor-pointer">
                <input type="checkbox" checked={agree} onChange={e => setAgree(e.target.checked)}
                  className="w-4 h-4 rounded border-gray-300 dark:border-gray-600 text-emerald-600 focus:ring-emerald-500 mt-0.5 cursor-pointer" />
                <span className="text-sm text-gray-600 dark:text-gray-400">I agree to <a href="#" className="text-emerald-600 dark:text-emerald-400 hover:underline">Terms</a> &amp; <a href="#" className="text-emerald-600 dark:text-emerald-400 hover:underline">Privacy Policy</a></span>
              </label>
            ...
            <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-6">
              ...
              <Link to="/login" className="font-semibold text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 transition">Sign In</Link>
            </p>
          </div>
          <p className="text-center text-xs text-gray-400 dark:text-gray-500 mt-4">Your data stays private and secure.</p>
        </div>
      </div>
    </div>
  )
