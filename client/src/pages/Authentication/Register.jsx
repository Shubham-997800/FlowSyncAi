          ...
          <div className="bg-white dark:bg-zinc-900 rounded-2xl p-8 border border-slate-200 dark:border-zinc-800 shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
              ...
              <label className="flex items-start gap-2 cursor-pointer">
                ...
                <span className="text-sm text-slate-600 dark:text-slate-400">I agree to <a href="#" className="text-indigo-600 dark:text-indigo-400 hover:underline">Terms</a> &amp; <a href="#" className="text-indigo-600 dark:text-indigo-400 hover:underline">Privacy Policy</a></span>
              </label>
            ...
            <button className="w-full flex items-center justify-center gap-2.5 py-2.5 rounded-xl border border-slate-300 dark:border-zinc-700 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-zinc-800 transition-colors duration-300">
