  ...
  return (
    <div className="group flex items-start gap-2 px-3 py-2 rounded-lg bg-slate-50 dark:bg-zinc-800 border border-slate-200 dark:border-zinc-700 hover:shadow-sm transition-shadow duration-300">
      ...
      <div className="flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        <button onClick={() => onEdit?.(task)} className="p-1 text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 rounded hover:bg-slate-100 dark:hover:bg-zinc-700 transition-colors">
          <Edit2 size={12} />
        </button>
        <button onClick={() => onDelete?.(task._id)} className="p-1 text-slate-400 hover:text-red-500 rounded hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors">
          <Trash2 size={12} />
        </button>
      </div>
    </div>
